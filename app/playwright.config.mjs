...
// Tests tagged @phone run only in the 390 projects, @desktop only in the 1280 ones (filtered by project, never counted as
// skipped). @shots (screenshots) run in all four projects.
